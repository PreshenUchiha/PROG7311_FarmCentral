<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Employee/EmployeeMaster.Master" AutoEventWireup="true" CodeBehind="ProductEV.aspx.cs" Inherits="FarmerMarket.Views.Employee.ProductV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Mybody" runat="server">
    ...
    <input type="date" class="form-control" id="ExpDate" runat="server">
        ...
        <asp:Button text="  Update  " CssClass="btn btn-success" runat="server" ID="EditBtn" OnClick="EditBtn_Click"/>
        <asp:Button text="Delete" CssClass="btn btn-success" runat="server" ID="DeleteBtn" OnClick="DeleteBtn_Click"/>

    </div>
     <div class="col-md-8">
         <h2 class="text-info">Hello Employee, Here Is The Details of The Farmers Products</h2>
