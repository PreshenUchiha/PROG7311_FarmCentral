<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Farmer/FarmerMaster.Master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="FarmerMarket.Views.Farmer.Products" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Mybody" runat="server">
    ...
    <input type="date" class="form-control" id="ExpDate" runat="server">
     ...
     <div class="col-md-8">
         <h2 class="text-info">Manage Products</h2>
